...
type MemberClient interface {
	...
	HandleRPC(ctx context.Context, in *RPCMessage, opts ...grpc.CallOption) (*MemberHandleResponse, error)
...
func (c *memberClient) HandleRPC(ctx context.Context, in *RPCMessage, opts ...grpc.CallOption) (*MemberHandleResponse, error) {
	out := new(MemberHandleResponse)
	err := c.cc.Invoke(ctx, "/clusterpb.Member/HandleRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemberServer interface {
	...
	HandleRPC(context.Context, *RPCMessage) (*MemberHandleResponse, error)
...
func (UnimplementedMemberServer) HandleRPC(context.Context, *RPCMessage) (*MemberHandleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleRPC not implemented")
}
...
func _Member_HandleRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RPCMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).HandleRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clusterpb.Member/HandleRPC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).HandleRPC(ctx, req.(*RPCMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Member_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Member_HandleRPC_Handler,
		},
		{
